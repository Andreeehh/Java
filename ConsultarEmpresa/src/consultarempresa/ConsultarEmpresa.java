 ...
 * @author andre
 */
public class ConsultarEmpresa {static final String banco = "jdbc:mysql://localhost:3306/empresa";
    ...
    try {
        ...
        consulta = conexao.prepareStatement("select nome,email,cargo,salario  from funcionarios where cargo = ? "); 
        String cargo = JOptionPane.showInputDialog(null,"Informe o cargo a ser consultado");
